...
public class ControllerHistory1 implements Initializable {
    public Label fName;
    public Label fAge;
    public TextField t1;
    @FXML
  ListView <Consultation>list_1;
    @FXML
    ListView <Consultation>list_2;
    @FXML
    ObservableList <Consultation>observableList1;
    ObservableList <Consultation>observableList2;

    @FXML
    ImageView imgeGander;
    Patient patient;
    public ControllerHistory1(Patient patient)
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        list_1.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent click) {
                ...
                Consultation p =  list_1.getSelectionModel().getSelectedItem();
        ...
        observableList1.setAll(db.getHistoryOfConsultation(patient.getId()));
...
//        list_2.setCellFactory(l->new MyListCell_8());
        ...
        FilteredList<Consultation> filteredData = new FilteredList<>(observableList1, s -> true);
        ...
        SortedList<Consultation> sortedLis= new SortedList<>(filteredData);
