...
public class ControllerHistory implements Initializable {
  ...
  ListView <Prescription>list_1;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        list_1.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent click) {
                ...
                if (click.getClickCount() == 2) {
                 ...
                 Prescription p =  list_1.getSelectionModel().getSelectedItem();
        ...
        FilteredList<Prescription> filteredData = new FilteredList<>(observableList1, s -> true);
        ...
        SortedList<Prescription> sortedLis= new SortedList<>(filteredData);
